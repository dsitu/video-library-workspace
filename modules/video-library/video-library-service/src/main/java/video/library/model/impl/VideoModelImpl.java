...
import video.library.model.VideoModel;
import video.library.model.VideoSoap;
...
public class VideoModelImpl extends BaseModelImpl<Video> implements VideoModel {
	...
	public static final String TABLE_SQL_CREATE = "create table VL_Video (uuid_ VARCHAR(75) null,videoId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(video.library.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.video.library.model.Video"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(video.library.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.video.library.model.Video"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(video.library.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.video.library.model.Video"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(video.library.service.util.ServiceProps.get(
				"lock.expiration.time.video.library.model.Video"));
